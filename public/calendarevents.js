...
const CalenderEvents = () => {
	...
	const handleSubmit = (evt) => {
		...
		let newEndDate = year_end + "-" + month_end + "-" + date_end + "T17:00:00-07:00";
								...
								return (
									<Col key={i}>
										<Card style={{ width: "18rem" }}>
											...
											<Card.Body>
												<Card.Title>
													{item.summary != null || item.summary == undefined ? item.summary
														.length >= 20 ? (
												...
												<Card.Text>
													{item.descripion == null || item.descripion == undefined ? (
														<p />
					...
					<Col>
						<Form style={{ marginBottom: 30 }} onSubmit={handleSubmit}>
							<Form.Group controlId="formBasicEmail">
								...
								/>
								<Form.Text className="text-muted">This is the title of your event</Form.Text>
							</Form.Group>
